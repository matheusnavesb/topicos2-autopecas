...
insert into dadostecnicos (modelo, fabricante, garantia, embalagem, peso) 
values ('modelo 00', 'fabricante 2', '2 anos', '40x20x40cm (Largura X Altura X Profundidade)', '8 kg');
insert into dadostecnicos (modelo, fabricante, garantia, embalagem, peso) 
values ('modelo 00', 'fabricante 3', '3 anos', '45x20x45cm (Largura X Altura X Profundidade)', '10 kg');